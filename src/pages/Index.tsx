...
const Index = () => {
  ...
  const handleAddFiles = async (files: FileList) => {
    try {
      ...
      toast({ title: 'Nahráno', description: `${files.length} soubor(ů) bylo nahráno na server` });
    } catch (e) {
      toast({ title: 'Chyba', description: 'Nepodařilo se nahrát soubory', variant: 'destructive' });
    }
  };
